...
HD_PWD='E:/github/zju/LogicAndComputerFundermental/final_project/final_tetris/final_test4/final_test.runs/over_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log over.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source over.tcl
